...
export default class ProviderRegister extends React.Component {
  ...
  change = (e) => {
    ...
    switch (name) {
      case "firstName":
        errors.firstName =
          value.length < 3 ? "First Name should be 3 characters long" : null;
        break;
      case "lastName":
        errors.lastName =
          value.length < 3 ? "Last name should be 3 characters long" : null;
        break;
      case "email":
      ...
      case "OrgAddress":
        errors.OrgAddress =
          value.length < 3 ? "Ivalid Organization address" : "";
        break;
      case "OrgRegNumber":
        errors.OrgRegNumber = value.length
          ? ""
          ...
          <Container maxWidth="sm" style={{ marginBottom: 50 }}>
            <form noValidate autoCapitalize="off">
              ...
              <GridContainer>
                <GridItem xs={12} sm={12} md={12}>
                  <span style={{ float: "left" }}>
                    Type of Registration<sup style={{ color: "red" }}>*</sup>
                  </span>
                  <TextField
                    fullWidth
                    size="small"
